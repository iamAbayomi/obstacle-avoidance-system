// This is the arduino code needed to control the obstacle avoidance vehicle.
// This code was adapted from the https://www.the-diy-life.com/arduino-based-obstacle-avoiding-robot-car/
...
byte echo = 13;
byte maxDist = 140;                               //Maximum sensing distance (Objects further than this distance are ignored)
